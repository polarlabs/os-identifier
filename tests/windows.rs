...
fn test_windows_7() {
    ...
    let windows = Windows::parse("windows-7-sp1");
...
fn test_windows_8() {
    ...
    let windows = Windows::parse("windows-8.1");
    assert!(windows.is_ok());
...
fn test_windows_10() {
    ...
    let windows = Windows::parse("windows-10-1809-w");
    assert!(windows.is_ok());
...
fn test_windows_10_1507_iot() {
    ...
    let windows = Windows::parse("windows-10-1507-iot");
    assert!(windows.is_ok());
...
fn test_windows_11_endoflife_1() {
    ...
    let windows = Windows::parse("windows-11-24h2-e");
    assert!(windows.is_ok());
...
fn test_windows_11_endoflife_2() {
    ...
    let windows = Windows::parse("windows-11-24h2-e-lts");
    assert!(windows.is_ok());
...
#[test]
fn test_windows_11_generic_4() {
    use os_identifier::Windows;

    let windows = Windows::parse("Windows 11 Pro 10.0.28000");
    assert!(windows.is_ok());

    let windows = windows.unwrap();
    let canonical_names = windows.to_string();
    assert!(canonical_names.contains(&String::from("Microsoft Windows 11 Pro 26H1")));
}
...
fn test_windows_server_1709() {
    ...
    let windows = Windows::parse("windows-server-1709-sac");
    assert!(windows.is_ok());
...
fn test_windows_server_23h2() {
    ...
    let windows = Windows::parse("windows-server-23h2-ac");
    assert!(windows.is_ok());
...
fn test_windows_2000() {
    ...
    let windows = Windows::parse("windows-server-2000-sp1");
    assert!(windows.is_ok());
...
fn test_windows_server_2003() {
    ...
    let windows = Windows::parse("windows-server-2003-sp1");
    assert!(windows.is_ok());
...
fn test_windows_server_2008() {
    ...
    let windows = Windows::parse("windows-server-2008-sp2");
    assert!(windows.is_ok());
...
fn test_windows_server_2008_r2() {
    ...
    let windows = Windows::parse("windows-server-2008-r2-sp1");
    assert!(windows.is_ok());
...
fn test_windows_server_2012() {
    ...
    let windows = Windows::parse("windows-server-2012");
    assert!(windows.is_ok());
...
fn test_windows_server_2012_r2() {
    ...
    let windows = Windows::parse("windows-server-2012-r2");
    assert!(windows.is_ok());
...
fn test_windows_server_2016() {
    ...
    let windows = Windows::parse("windows-server-2016");
    assert!(windows.is_ok());
...
fn test_windows_server_2019() {
    ...
    let windows = Windows::parse("windows-server-2019");
    assert!(windows.is_ok());
...
fn test_windows_server_2022() {
    ...
    let windows = Windows::parse("windows-server-2022");
    assert!(windows.is_ok());
...
fn test_windows_server_2025() {
    ...
    let windows = Windows::parse("windows-server-2025");
    assert!(windows.is_ok());
...
fn test_windows_vista() {
    ...
    let windows = Windows::parse("windows-6-sp2");
    assert!(windows.is_ok());
...
fn test_windows_xp() {
    ...
    let windows = Windows::parse("windows-5-sp3");
    assert!(windows.is_ok());
